...
public class YelpAPI {
	 ...
	 */
	// Not used anymore, since original Oauth2.0 is obsolete for Yelp API
	private String getAccessToken() {
	  ...
	  public List<Item> search(double lat, double lon, String term) {
	    ...
	    try {
	      ...
	      // add request header
	      // With OAuth 2.0 the process to authenticate
	      ...
	      // return (JSONArray) jsonObject.get("businesses");
	    } catch (Exception e) {
	      e.printStackTrace();
	    }
	    return null;
	  ...
	  public static void main(String[] args) {
	    ...
	    yelpApi.queryAPI(37.255, -121.938);
	  }
}
